...
\title{%
  ...
  \large\normalfont Version~5.0.0 (2025/03/15)}
...
\begin{tabular}{@{}ll@{}}
  ...
  \file{documentation.tex} & This user manual (source) \\
  \file{example.tex}     & Complete compilable usage example \\
  \file{example.bib}     & Bibliography database for the example \\
...
\medskip
\noindent
Copyright \textcopyright\ 2001–2025 UFRGS TeX Users Group\\
