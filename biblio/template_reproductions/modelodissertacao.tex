...
nota de rodapé. A seguir um exemplo com nota de rodapé:
    ...
    % Este exemplo não foi reproduzido.
    % Não sei como fazer, e não creio que seja muito usado.
	Segundo Franco\footciteref{franco} (apud FURTADO, 1996, p. 5), texto texto texto texto texto
